...
using { divya.common } from './common';
...
context master {
    ...
    entity businesspartner {
        ...
        ADDRESS_GUID: Association to address @(title : '{i18n>ADDRESS_KEY}');
        BP_ID: String(32);
        COMPANY_NAME: String(250) @(title : '{i18n>COMPANY_NAME}');
    }
 
    entity address {
        key NODE_KEY: common.Guid @(title : '{i18n>ADDRESS_KEY}');
        CITY: String(44);
...
context transaction {
    ...
    entity poitems: cuid,common.Amount{
        //key NODE_KEY: common.Guid @(title : '{i18n>ITEM_KEY}');
        PARENT_KEY: Association to purchaseorder;
        PO_ITEM_POS: Integer @(title : '{i18n>ITEM_NO}');
